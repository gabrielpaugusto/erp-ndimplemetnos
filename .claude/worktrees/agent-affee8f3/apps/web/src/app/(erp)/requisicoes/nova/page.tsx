...
const typeOptions: { key: ReqType; label: string; desc: string; icon: React.ReactNode }[] = [
  { key: 'INTERNA', label: 'Interna', desc: 'Materiais da Industria para Oficina — sem NF-e', icon: <Building2 className="w-5 h-5" /> },
  { key: 'COMPRA', label: 'Compra', desc: 'Necessita processo de compra', icon: <ShoppingCart className="w-5 h-5" /> },
  { key: 'TRANSFERENCIA', label: 'Transferencia', desc: 'Entre setores', icon: <ArrowRightLeft className="w-5 h-5" /> },
];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-lg font-semibold text-slate-900">Tipo de Requisicao *</h2>
        </div>
