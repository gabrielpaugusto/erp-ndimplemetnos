...
export default function NovoContaReceberPage() {
  ...
  const clientes = [
    { id: '1', name: 'Transportadora Rodoviaria Sul' },
    { id: '2', name: 'Logistica Express Ltda' },
    { id: '3', name: 'Agro Transportes SA' },
    { id: '4', name: 'Distribuidora Norte Ltda' },
    { id: '5', name: 'Mudancas Rapidas ME' },
  ];
  ...
  const categorias = [
    { id: '1', name: '3.1 - Receita Bruta de Vendas' },
    { id: '2', name: '3.2 - Receita de Servicos' },
    { id: '3', name: '3.3 - Outras Receitas Operacionais' },
  ];
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      alert('Titulo a receber cadastrado com sucesso! (mock)');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <button onClick={handleSave} disabled={saving || !cliente || !descricao || !valor || !dataVencimento} className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
