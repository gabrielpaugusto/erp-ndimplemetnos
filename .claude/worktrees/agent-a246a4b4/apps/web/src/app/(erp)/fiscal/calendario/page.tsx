...
import { RefreshCw, AlertTriangle, Clock, CheckCircle2, Calendar } from 'lucide-react';
...
function EventoRow({ ev }: { ev: Evento }) {
  const rowBg = ev.atrasado ? 'bg-red-50' : ev.urgente ? 'bg-amber-50' : '';
  return (
    <tr className={`${rowBg} hover:bg-slate-50 transition-colors border-b border-slate-100`}>
