...
export default function NovoFuncionarioPage() {
  ...
  // Contrato
  const [dataAdmissao, setDataAdmissao] = useState('2026-03-14');
  ...
  const pessoas = [
    { id: '1', name: 'Carlos Alberto Silva - CPF 123.456.789-00' },
    { id: '2', name: 'Maria Fernanda Costa - CPF 234.567.890-11' },
    { id: '3', name: 'Jose Roberto Oliveira - CPF 345.678.901-22' },
    { id: '4', name: 'Nova Pessoa (cadastrar)' },
  ];
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      alert('Funcionario cadastrado com sucesso! (mock)');
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">Selecione uma pessoa ja cadastrada no sistema ou cadastre uma nova</p>
        </div>
      </div>
