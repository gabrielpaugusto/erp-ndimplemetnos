  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">CFOP</h1>
          <p className="text-slate-500 text-sm mt-0.5">Código Fiscal de Operações e Prestações</p>
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50">
              ...
              <th className="px-4 py-3 text-left font-medium text-slate-600">Natureza da Operação</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-slate-100">
            {loading ? (
              ...
              <tr key={item.id} className="hover:bg-slate-50">
                ...
                <td className="px-4 py-3 text-slate-500 text-xs">{item.naturezaOp || '-'}</td>
              </tr>
            ))}
          </tbody>
        </table>
