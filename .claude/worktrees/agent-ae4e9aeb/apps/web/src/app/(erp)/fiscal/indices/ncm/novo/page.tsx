...
const emptyForm = (): NcmForm => ({
  code: '', description: '', exTipi: '',
  aliquotaIpi: '', cstIpiEntrada: '00', cstIpiSaida: '50',
  cstIcms: '00', reducaoBcIcms: '', csosn: '102',
  temSt: false, cestCode: '', cestDescricao: '',
  cstPisCofinsSaida: '01', cstPisCofinsEntrada: '50',
  aliquotaPis: '1.65', aliquotaCofins: '7.60', monofasico: false,
  aliquotaImportacao: '',
  aliquotaCbs: '', cstCbs: '', aliquotaIbs: '', cstIbs: '',
  temIs: false, aliquotaIs: '', categoriaIs: '', categoriaReforma: 'BEM',
  regimeEspecialReforma: '', observacoes: '',
  active: true,
});
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">Cadastro completo de Nomenclatura Comum do Mercosul</p>
        </div>
      </div>
