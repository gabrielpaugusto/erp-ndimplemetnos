...
import { CfopSelect } from '@/components/fiscal/cfop-select';
...
export default function NovaNFeFormPage() {
  ...
  // Operadores podem emitir NF-e (CREATE) mas não alterar parâmetros fiscais (MANAGE)
  const fiscalParamsReadOnly = !canConfigurar('FISCAL') && !isSuperAdmin;
              ...
              <div className="grid grid-cols-12 gap-2 p-3 items-end">
                ...
                <div className="col-span-1">
                  <label className="block text-xs font-medium text-slate-500 mb-1 flex items-center gap-1">
                    NCM {fiscalParamsReadOnly && <Lock className="w-3 h-3 text-slate-300" />}
                  </label>
                  <NcmPicker
                    value={item.ncm}
                    readOnly={fiscalParamsReadOnly}
                    onSelect={(ncm) => updateItem(item.id, 'ncm', ncm.code)}
                  />
                </div>
                <div className="col-span-1">
                  <label className="block text-xs font-medium text-slate-500 mb-1 flex items-center gap-1">
                    CFOP {fiscalParamsReadOnly && <Lock className="w-3 h-3 text-slate-300" />}
                  </label>
                  <CfopSelect
                    value={item.cfop}
                    readOnly={fiscalParamsReadOnly}
                    onSelect={(cfop) => updateItem(item.id, 'cfop', cfop.code)}
                  />
                </div>
                <div className="col-span-1">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      <div className="bg-white rounded border border-slate-200 p-2">
                        ...
                        <p className="text-[10px] text-slate-500">CST: {item.icms.cst} | Alíq: {fmtPercent(item.icms.aliquota)}</p>
                      ...
                      <div className="bg-white rounded border border-slate-200 p-2">
                        ...
                        <p className="text-[10px] text-slate-500">CST: {item.ipi.cst} | Alíq: {fmtPercent(item.ipi.aliquota)}</p>
                      ...
                      <div className="bg-white rounded border border-slate-200 p-2">
                        ...
                        <p className="text-[10px] text-slate-500">CST: {item.pis.cst} | Alíq: {fmtPercent(item.pis.aliquota)}</p>
                      ...
                      <div className="bg-white rounded border border-slate-200 p-2">
                        ...
                        <p className="text-[10px] text-slate-500">CST: {item.cofins.cst} | Alíq: {fmtPercent(item.cofins.aliquota)}</p>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="bg-white rounded border border-teal-200 p-2">
                        ...
                        <p className="text-[10px] text-slate-500">Alíq: {fmtPercent(item.ibs.aliquota)}</p>
                      ...
                      <div className="bg-white rounded border border-teal-200 p-2">
                        ...
                        <p className="text-[10px] text-slate-500">Alíq: {fmtPercent(item.cbs.aliquota)}</p>
                      ...
                      <div className="bg-white rounded border border-teal-200 p-2">
                        ...
                        <p className="text-[10px] text-slate-500">Alíq: {fmtPercent(item.is.aliquota)}</p>
