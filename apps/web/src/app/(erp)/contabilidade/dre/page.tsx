...
function formatCurrency(value: number): string { return fmtCurrency(value); }
...
export default function DrePage() {
  ...
  const handleSaveSnapshot = async () => {
    ...
    try {
      const res = await apiFetch(`/api/accounting/dre/snapshot?periodo=${periodo}`, { method: 'POST' });
      if (res.ok) await loadDre();
    } catch {
      // silent
    } finally {
