...
// TIPOS_FORN: mantém SIMPLES_NACIONAL/MEI para compatibilidade com regras legadas no BD.
// Novas regras devem usar ramoAtividade + regime (motor fiscal resolve automaticamente).
const TIPOS_FORN  = ['INDUSTRIA','ATACADISTA_EQUIPARADO','COMERCIO','PRESTADOR_SERVICO','SIMPLES_NACIONAL','MEI','IMPORTADOR','PESSOA_FISICA'];
const TIPOS_CLI   = ['CONTRIBUINTE','CONTRIBUINTE_SIMPLES','NAO_CONTRIBUINTE'];
const TIPOS_OP    = ['ENTRADA','SAIDA'];
// MEI removido de REGIMES: use SIMPLES_NACIONAL para fornecedores MEI.
